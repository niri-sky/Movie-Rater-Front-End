        ...
        const mov = this.props.movie;
            //fetch data
                ...
                headers: {
                    ...
                    'Authorization': 'Token c63988bcd49bdeab187c452f11e83c1ef8db9ded'
    ...
    render() { 
        ...
        return (
            <React.Fragment>
                ...
                {this.props.movie.id ? 
                <button disabled={isDisabled} onClick={this.updateClicked}>Update</button> : <button onClick={this.saveClicked}>Save</button> }
                
                &nbsp;
                <button disabled={isDisabled} onClick={this.cancelClicked}>Cancel</button>
            </React.Fragment>
                )
  }}
